//slugify convert sea Vill ti sea-vill means web address
...
const propertySchema = new mongoose.Schema({
    ...
    amenities:[
        {
            name:{
                ...
                required:true,
                enum:[
                    "Wifi","Kitchen","Ac","Waching Machine",
                    "Tv","Pool","Free Parking"
                ]
            },
            icon:{
                type:String,
    ...
    slug:String,
    checkInTime:{
        type:String,default:"11:00"
    },
    checkOutTime:{
        type:String,default:"13:00"
    }
})
